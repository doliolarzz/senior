...
convlstm_encoder_params = [
    ...
    [
        ConvLSTM(input_channel=8, num_filter=64, b_h_w=(batch_size, 144, 240),
                 kernel_size=3, stride=1, padding=1),
        ConvLSTM(input_channel=192, num_filter=192, b_h_w=(batch_size, 48, 80),
                 kernel_size=3, stride=1, padding=1),
        ConvLSTM(input_channel=192, num_filter=192, b_h_w=(batch_size, 24, 40),
                 kernel_size=3, stride=1, padding=1),
    ]
]
...
convlstm_forecaster_params = [
    ...
    [
        ...
        ConvLSTM(input_channel=192, num_filter=192, b_h_w=(batch_size, 48, 80),
                 kernel_size=3, stride=1, padding=1),
        ConvLSTM(input_channel=64, num_filter=64, b_h_w=(batch_size, 144, 240),
                 kernel_size=3, stride=1, padding=1),
    ]
]
